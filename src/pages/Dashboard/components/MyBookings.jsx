...
const MyBookings = () => {
  ...
  const filteredBookings = allBookings.filter((b) => {
    ...
    const chefName = (
      b.chefInfo?.userName ||
      b.chefInfo?.fullName ||
      (b.chefInfo?.firstName
        ? `${b.chefInfo?.firstName} ${b.chefInfo?.lastName}`
        : "") ||
      "A Chef"
    ).toLowerCase();
  ...
  const bookings = {
    ...
    past: filteredBookings.filter((b) =>
      ["completed", "cancelled"].includes(b.bookingDetails?.status),
    ),
  };
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-500 font-medium text-sm md:text-base">
            Manage your upcoming and past culinary experiences.
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Button
          variant="outline"
          className="h-14 px-6 border-gray-100 bg-white rounded-2xl gap-3"
        >
          <Filter size={18} />
        ...
        {isLoading ? (
          ...
          bookings[activeTab].map((booking) => (
            <Card
              ...
              className="p-0 border-transparent shadow-sm hover:shadow-md transition-all overflow-hidden bg-white"
            >
              <div className="flex flex-col sm:flex-row">
                <div className="sm:w-48 h-44 sm:h-auto overflow-hidden shrink-0">
                  <img
                    src={getImageUrl(
                      booking.chefInfo?.image ||
                        booking.chefInfo?.profile?.image,
                    )}
                    alt={booking.chefInfo?.userName || "Chef"}
                ...
                <div className="flex-1 p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex flex-col gap-1">
                        ...
                        <h3 className="text-xl font-bold text-primary-900">
                          {booking.chefInfo?.userName ||
                            booking.chefInfo?.fullName ||
                            "A Chef"}
                        </h3>
                      </div>
                      <Badge
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-xs font-bold text-primary-900">
                          {formatDate(booking.bookingDetails.eventDate)}
                        </span>
                      </div>
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-gray-400">
                        ...
                        <span className="text-xs font-bold text-primary-900">
                          {booking.bookingDetails.arrivalTime}
                        </span>
                      </div>
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-gray-400">
                        ...
                        <span className="text-xs font-bold text-primary-900 truncate max-w-[150px]">
                          {booking.bookingDetails.eventLocation || "TBD"}
                        </span>
                      </div>
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2 text-gray-400">
                  ...
                  <div className="flex md:flex-col gap-3">
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/dashboard/bookings/${booking.bookingDetails._id}/manage`,
                        )
                      }
                    >
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/dashboard/bookings/${booking.bookingDetails._id}`,
                        )
                      }
                    >
          ...
          <div className="py-20 flex flex-col items-center text-center gap-6 bg-white rounded-[40px] border border-dashed border-gray-200">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-gray-500 max-w-xs font-medium">
                You haven't scheduled any experiences yet. Start by browsing our
                elite chefs.
              </p>
            </div>
            <Button
          ...
          <Card className="w-full max-w-md bg-white rounded-3xl p-6 md:p-8 flex flex-col gap-6 relative shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-gray-500">
                Rate your experience with {reviewModal.chefName}
              </p>
            </div>
