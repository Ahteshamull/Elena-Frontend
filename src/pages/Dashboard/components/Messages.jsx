...
export default function Messages() {
    ...
    .map((conv) => {
      ...
      return {
        ...
        specialty:
          ...
          (participant?.role === "chef" ? "Chef" : "Client"),
        status: "online",
        unread: unreadCount,
  ...
  const suggestions = [
    {
      label: "Dietary Needs",
      text: "I wanted to discuss dietary adjustments.",
    },
        ...
        {activeChat ? (
          ...
          >
            ...
            <p className="text-gray-400 text-sm max-w-sm leading-relaxed font-light">
              Select a conversation from the left sidebar to coordinate menus,
              schedule timings, and plan an unforgettable dining experience.
            </p>
          </div>
        )}
      </div>
