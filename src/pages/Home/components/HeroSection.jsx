        ...
        <div className="bg-white/95 backdrop-blur-md p-3 md:p-4 rounded-2xl shadow-xl flex flex-col md:flex-row items-stretch gap-3 md:gap-4 max-w-5xl">
          ...
          <div className="flex-1 flex items-center gap-3 px-4 py-2">
            ...
            <div className="flex flex-col w-full">
              ...
              <select className="w-full bg-transparent border-none outline-none text-primary-900 placeholder:text-gray-400 focus:ring-0 p-0 text-sm cursor-pointer appearance-none">
