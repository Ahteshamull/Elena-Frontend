    ...
    <div className="pt-32 pb-24 min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16 md:mb-24">
          <h1 className="text-3xl md:text-5xl font-serif text-primary-900 mb-6 italic">
            Join the Tableli Team
          </h1>
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-serif text-primary-900 mb-8 italic">
            Open Positions
          </h2>
          {jobs.map((job, idx) => (
            <div
              key={idx}
              className="group p-6 md:p-8 rounded-3xl border border-gray-100 bg-[#FAFAFA] hover:bg-white hover:border-accent hover:shadow-xl hover:shadow-accent/5 transition-all duration-300"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex flex-col gap-3">
                  ...
                  <h4 className="text-xl md:text-2xl font-bold text-primary-900">
                    {job.title}
                  </h4>
        ...
        <div className="mt-24 text-center p-12 rounded-[40px] bg-primary-900 text-white">
          ...
          <a
            href="mailto:careers@tableli.com"
