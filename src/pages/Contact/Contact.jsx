    ...
    <div className="w-full flex flex-col items-center bg-[#FAFAFA]">
      ...
      <section className="w-full max-w-4xl mx-auto px-6 py-20 md:py-32 flex flex-col items-center text-center">
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-2xl leading-relaxed">
          Experience bespoke service tailored to your most refined desires. Our dedicated team is at your disposal to craft every detail of your journey.
        </p>
      </section>

      {/* 2. Inquiry Form & Direct Assistance */}
      <section id="inquiry-form" className="w-full max-w-7xl mx-auto px-6 pb-20 md:pb-32">
        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="col-span-1 lg:col-span-8 bg-white rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm border border-gray-100">
            <h2 className="text-3xl font-serif font-medium text-gray-900 mb-12">Inquiry Form</h2>
            ...
            {isSubmitted ? (
              <div className="flex flex-col items-center py-12 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4">Message Received</h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-10">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] uppercase font-bold tracking-[0.15em] text-gray-900">Full Name</label>
                    <input 
                      name="name"
                      type="text" 
                      required
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] uppercase font-bold tracking-[0.15em] text-gray-900">Email Address</label>
                    <input 
                      name="email"
                      type="email" 
                      required
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] uppercase font-bold tracking-[0.15em] text-gray-900">Subject</label>
                  <input 
                    name="subject"
                    type="text" 
                    required
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] uppercase font-bold tracking-[0.15em] text-gray-900">Message</label>
                  <textarea 
                    name="message"
                    required
                ...
                <div className="mt-4">
                  ...
                  >
                    {isSubmitting ? "SENDING..." : "SEND INQUIRY"} <span className="text-lg leading-none">→</span>
                  </Button>
                </div>
              </form>
            )}
          ...
          <div className="col-span-1 lg:col-span-4 bg-[#F5F5F0] rounded-3xl p-8 md:p-10 flex flex-col items-center gap-6 shadow-sm">
            ...
            <div className="flex flex-col items-center sm:items-start lg:items-center xl:items-start text-center sm:text-left lg:text-center xl:text-left">
              <h3 className="text-xl font-bold text-gray-900 mb-1">Direct Assistance</h3>
