...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="bg-[#0A0A0A] text-white pt-12 md:pt-20 pb-8"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Footer Links */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16">
          <div className="col-span-2 md:col-span-1">
            <span className="font-serif text-3xl font-semibold tracking-wider text-accent mb-6 block">
              TABLELI
            </span>
            <p className="text-gray-400 text-sm leading-relaxed">
              Exquisite Private Dining, Tailored to You. We connect you with
              world-class chefs for unforgettable culinary experiences.
            </p>
